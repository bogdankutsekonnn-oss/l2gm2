...
export const useSeo = () => {
  ...
  const generateHomeSeoText = () => {
    const paragraphs = [
      ...
      `Как выбрать лучший сервер? Ориентируйтесь на дату старта: новые сервера Л2, открывающиеся сегодня или завтра, собирают максимальный онлайн — заходить в первый день выгоднее всего. Проекты со статусом Premium и VIP закреплены в топе списка: это сервера с подтверждённой репутацией и стабильным онлайном.`,
