...
Что такое баннерная реклама на L2GM? Баннерная реклама — это графический блок размером 240x400 пикселей, который показывается в боковой колонке сайта. Поддерживаются форматы GIF, PNG и JPG. В ротации может находиться до 5 баннеров одновременно, показы распределяются случайным образом. Стоимость размещения составляет $14 за 30 дней. Шаблоны для подготовки материалов доступны в Figma.

Что такое брендирование сайта? Брендирование — это размещение фонового изображения (обложки) размером 1920x1080 пикселей, которое видят все посетители L2GM. Это максимальный охват аудитории. Стоимость — $100 за 30 дней. Анимация в брендировании не допускается.

Как работают статусы VIP и Premium? VIP и Premium — это платные статусы, которые меняют позицию сервера в каталоге. Карточка сервера с повышенным статусом отображается выше остальных, получает уникальное визуальное оформление и дублируется в нескольких разделах. Premium ($40 за позицию) обеспечивает максимальную заметность с размещением в самом верху каталога. VIP ($20 за позицию) даёт приоритетное расположение и выделенный дизайн. Стандартный VIP ($9 или $5 с кнопкой) — бюджетный вариант с повышенной видимостью.

Все тарифы рассчитаны на 30-дневный цикл размещения. Для серверов с ограниченным бюджетом доступен эконом-вариант: установите кнопку L2GM на сайт проекта и получите VIP-статус по сниженной цене $5 вместо $9. Оформление размещения — через Telegram.`
